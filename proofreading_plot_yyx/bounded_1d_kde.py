# Original file:
# https://github.com/pesummary/pesummary/blob/1cc88a1aef4ceda59d6856e1f7049eb7cc93a0d2/pesummary/utils/bounded_1d_kde.py#L210
# By Charlie Hoy <charlie.hoy@ligo.org> & Michael Puerrer <michael.puerrer@ligo.org>
# Licensed under an MIT style license
# https://github.com/pesummary/pesummary?tab=License-1-ov-file

# Modified by Yuxuan Yan <yanyuxuan@westlake.edu.cn>
# make this file can be used individually and do not depend on the entire pesummary package.
# 2025.03.21
# Modification licensed under MIT license
...
class ReflectionBoundedKDE(BoundedKDE):
    ...
    def evaluate(self, pts):
        ...
        if self.xlow is not None:
            pdf += super(ReflectionBoundedKDE,
                         self).evaluate(2 * self.xlow - x)
        if self.xhigh is not None:
            pdf += super(ReflectionBoundedKDE,
                         self).evaluate(2 * self.xhigh - x)
        return pdf
