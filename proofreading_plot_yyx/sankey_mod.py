"""
Original file: __init__.py (https://github.com/toobaz/mpl_sankey/blob/master/mpl_sankey/__init__.py)
Original author: Pietro Battiston <me@pietrobattiston.it>
Original license: LGPL - 3.0Modified by: Yuxuan Yan <yanyuxuan@westlake.edu.cn>
Date: 2024/12/27
Modifications:
...
def sankey(data, nodes_color=DEFAULT_COLOR, flows_color=None,
    ...
    for phase in range(phases):
        ...
        l_sizes, r_sizes = (s.pipe(lambda x: x[x > 0])
                            for s in (l_sizes, r_sizes))
